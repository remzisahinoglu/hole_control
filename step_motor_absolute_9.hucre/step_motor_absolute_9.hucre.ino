...
const int referans_switch = 11;                                           // referans swtich
const int manuel = 12;                                                    // manuel-auto switch
//**** ilk yapilan makinede ref switchi ile man/auto switchi ters ***** 
...
int adim_adedi_16T = 320;         // 36,5 >> 38,5mm ye çık (2mm = 320adım)
int adim_adedi_20T = 1200;        // 36,5 >> 44mm ye çık (7,5mm = 1500adım)
int adim_adedi_24T = 1520;        // 36,5 >> 46mm ye çık (9,5mm = 1900adım)
int adim_adedi_30T_K = 480;       // 36,5 >> 39,5mm ye çık (3mm = 480adım)
int adim_adedi_30T_U = 3040;      // 36,5 >> 55,5mm ye çık (19mm = 3040adım)
